...
import logging
from model.skateformer import SkateFormer  # 假设 SkateFormer 模型在 model/skateformer.py 文件中
...
def main():
    ...
    best_auc = -1
    best_metrics = {}
    best_model_path = 'weights/skateformer_best_model.pth'
    ...
    plt.savefig('skateformer_roc_curve.png')
    log_message("ROC curve saved as '2_roc_curve.png'")
    ...
    plt.legend()
    plt.savefig('skateformer_loss_curve.png')
    log_message("Loss curve saved as '2_loss_curve.png'")
